...
public class CatUnitTest {
 ...
 src/test/java/edu/pitt/cs/RentACatIntegrationTest.java
 Download
package edu.pitt.cs;
...
public class RentACatIntegrationTest {
     ...
     * test case.
     */
    Method getCatMethod; // Method object for the private getCat(int) method
    ...
    // Output stream for testing system output
    ...
    public void setUp() throws Exception {
        ...
        try {
            getCatMethod = r.getClass().getDeclaredMethod("getCat", int.class);
    ...
    public void testGetCatNullNumCats0() {
        Object cat;
        try {
            cat = getCatMethod.invoke(r, 2);
            assertNull(cat);
            assertEquals("Invalid cat ID." + newline, out.toString());
        } catch (IllegalAccessException e) {
            fail("Couldn't find getCat method");
        } catch (InvocationTargetException e) {
            fail("Couldn't invoke getCat method");
        }
    }
    ...
    public void testGetCatNumCats3() {
        ...
        r.addCat(c3);
        try {
            Object cat = getCatMethod.invoke(r, 2);
            assertNotNull(cat);
            if (cat instanceof Cat) {
                assertEquals(2, ((Cat) cat).getId());
            } else {
                fail("Returned object is not a Cat");
            }
        } catch (IllegalAccessException | InvocationTargetException e) {
            fail("Couldn't find or invoke getCat method");
        }
    }
    ...
    public void testListCatsNumCats0() {
        String retListCats = r.listCats();
        assertEquals("", retListCats);
    }
    ...
    public void testRenameFailureNumCats0() {
        boolean retRenameCat = r.renameCat(2, "Garfield");
        assertFalse(retRenameCat);
        assertEquals("Invalid cat ID." + newline, out.toString());
    }
    ...
    public void testRentCatNumCats3() {
        ...
        r.addCat(c2);
        r.addCat(c3);
        boolean retRentCat = r.rentCat(2);
        assertTrue(retRentCat);
    ...
    public void testReturnCatNumCats3() {
        ...
        r.addCat(c3);
        c2.rentCat();
        boolean retReturnCat = r.returnCat(2);
        assertTrue(retReturnCat);
